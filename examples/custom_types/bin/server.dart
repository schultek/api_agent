...
import 'package:api_agent_custom_types_example/shared/definitions.server.dart';
...
class GreetApiImpl extends GreetApiEndpoint {
  @override
  Data greet(String name, ApiRequest _) {
    return Data('Hello $name.');
  }

  @override
  FutureOr<T> getGeneric<T>(int value, ApiRequest request) {
    if (T == typeOf<Value<int>>()) return Value(value) as T;
    throw 'Cannot get for type $T';
  }

  @override
  FutureOr<int> sendGeneric<T>(T data, covariant ApiRequest request) {
    print('GOT GENERIC $T: $data');
    return 10;
  }
}
